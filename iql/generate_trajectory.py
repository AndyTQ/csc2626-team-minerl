...
if __name__ == "__main__":
    ...
    #     'tianquan/MineRLTreechop-v0/agent:v387', type='model')
    artifact = run.use_artifact(
        'tianquan/MineRLNavigateDense-v0/agent:v180', type='model')
    ...
    for _ in range(10):
        trajectory = generator.generate(max_episode_length=18000)
        print("reward" + str(_) + ": " + str(sum(trajectory.rewards)))
